...
Related public work: [atlas-portable-index](https://github.com/atlaslaw2026/atlas-portable-index) (the bind entry point — where a new model or session binds to Atlas and operates from its verified state), [Atlas-Law-Viewer](https://github.com/atlaslaw2026/Atlas-Law-Viewer) (product demo).
